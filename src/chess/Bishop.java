...
public class Bishop extends Chess{
    ...
    public static final Image whiteIcon = new Image("file:resources/image/whiteBishop.png", ChessPane.ICON_SIZE, ChessPane.ICON_SIZE, true, true);
    public static final Image blackIcon = new Image("file:resources/image/blackBishop.png", ChessPane.ICON_SIZE, ChessPane.ICON_SIZE, true, true);

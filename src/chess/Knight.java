...
public class Knight extends Chess{
    ...
    public static final Image whiteIcon = new Image("file:resources/image/whiteKnight.png", ChessPane.ICON_SIZE, ChessPane.ICON_SIZE, true, true);
    public static final Image blackIcon = new Image("file:resources/image/blackKnight.png", ChessPane.ICON_SIZE, ChessPane.ICON_SIZE, true, true);

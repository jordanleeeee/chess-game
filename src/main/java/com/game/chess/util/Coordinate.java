...
public class Coordinate {
    ...
    public List<Coordinate> getSoundingPosition() {
    ...
    public List<Coordinate> get_L_Shape_MovingPosition() {
        List<Coordinate> possibleMove = new ArrayList<>();
    ...
    private void removeInvalidCoordinate(List<Coordinate> possibleMove) {
